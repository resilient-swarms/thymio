/**
 * @file <argos3/plugins/robots/Thymio/control_interface/ci_Thymio_encoder_sensor.h>
 *
...
#ifndef CCI_Thymio_ENCODER_SENSOR_H
#define CCI_Thymio_ENCODER_SENSOR_H

/* To avoid dependency problems when including */
namespace argos {
   class CCI_ThymioEncoderSensor;
}
...
namespace argos {
   ...
   class CCI_ThymioEncoderSensor : public CCI_Sensor {
   ...
   public:
       ...
       * Destructor
       */
      virtual ~CCI_ThymioEncoderSensor() {}
