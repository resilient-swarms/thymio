/**
 * @file <argos3/plugins/robots/Thymio/control_interface/ci_Thymio_ground_sensor.h>
 *
 * @brief This file provides the interface of the Thymio IV ground sensor.
 *
...
#ifndef CCI_Thymio_GROUND_SENSOR_H
#define CCI_Thymio_GROUND_SENSOR_H

namespace argos {
   class CCI_ThymioGroundSensor;
}
...
namespace argos {
   ...
   class CCI_ThymioGroundSensor : virtual public CCI_Sensor {
